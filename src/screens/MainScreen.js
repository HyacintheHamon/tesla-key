                ...
                <Animated.View style={{flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.6)'}}>
                        ...
                        <View style={styles.bottomView}>
                            ...
                            <View style={styles.buttonGroup}>
                                <View style={styles.buttonRow}>
                                    ...
                                    <TouchableOpacity style={styles.button}
                                                      nPress={this.onAnimationClickForwardSeatRight}>
                                        <LottieView
                                            ref={animation => {
                                                this.animation = animation;
                                            }}
                            ...
                            <Svg height={height} width="100%">
                                <Defs>
                                    <Mask id="mask" x="0" y="0" height={height} width="100%">
                                        ...
                                        <AnimatedCircle ref={ref => this._myCircle = ref} cx="-50" cy="-50" r="50"
                                                        fill="black"/>
                                    </Mask>
                                </Defs>
                                <Rect height="100%" width="100%" fill="rgba(107, 107, 23, 0.5)" mask="url(#mask)"
                                      fill-opacity="0"/>
                            </Svg>
                        </View>
                    }
                    ...
                    >
                        <ClimateControlsModalScreen
                            onCloseClimateControlsModal={() => this.closeClimateControlsModal()}/>
                    </Modal>
    ...
    render() {
        ...
        return (
            <Animatable.View style={{flex: 1, backgroundColor: '#111117'}}>
                <Animatable.View style={styles.topContainer} activeOpacity={1} animation={this.state.animatedShow}
                                 iterationCount={1} iterationDelay={150} direction="alternate">
                    <View style={styles.button}>
                        <Image style={styles.lockButtonIcon} source={frunk}/>
                        <Animatable.Text
                            style={{...styles.lockText, opacity: this.funkAnimated}}>Frunk</Animatable.Text>
                    </View>
                    <View>
                        <Entypo
                            name={'lock'}
                        ...
                        />
                        <Animatable.Text
                            style={{...styles.lockText, opacity: this.lockAnimated}}>Unlock</Animatable.Text>
                    </View>
                    <View>
                        <Image style={styles.lockButtonIcon} source={trunk}/>
                        <Animatable.Text
                            style={{...styles.lockText, opacity: this.trunkAnimated}}>Trunk</Animatable.Text>
                    </View>
                </Animatable.View>
