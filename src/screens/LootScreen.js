...
import { StyleSheet, Text, View, ScrollView, SafeAreaView, TouchableOpacity, Dimensions, Linking } from "react-native";
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={styles.bodyContainer} >
          ...
          <Text style={styles.learnMore} onPress={() => { Linking.openURL('https://www.tesla.com/support/referral-program&redirect=no') }}>Learn more</Text>
        </ScrollView>
      </SafeAreaView>
    );
  }
