...
export type NearbyChargingSitArgs = {
    id: string,
}

export type NearbyChargingSitePayload = {
    response: {
...
export type NearbyChargingSiteResult = {
    nearbyChargingSite: NearbyChargingSitePayload,
}

export const NEARBY_CHARGING_SITES = gql`
    query NearbyChargingSite($id: String!) {
        nearbyChargingSit(id: $id) @rest(
            path: "/api/1/vehicles/{args.id}/earby_charging_sites"
            type: "NearbyChargingSite"
            method: "GET"
        ) {
            response
        }
