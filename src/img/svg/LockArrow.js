...
const SvgComponent = props => (
  <View>
    <Svg width="20" height="40" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.974 31.632">
      <G>
	    <Path fill="#FFFFFF" d="M13.083,7V5.642C13.083,2.526,10.557,0,7.441,0H7.392C4.276,0,1.75,2.526,1.75,5.642V7
	    ...
	    <Path fill="#FFFFFF" d="M7.5,31.632c-0.266,0-0.52-0.105-0.707-0.293l-6.475-6.474c-0.391-0.391-0.391-1.023,0-1.414
