...
const SvgComponent = props => (
  <View>
    <Svg width="25px" height="15px" viewBox="0 0 17 10" xmlns="http://www.w3.org/2000/svg" {...props}>
      <Defs>
        <Polygon points="0 -0.00038 16.442 -0.00038 16.442 9.48037 0 9.48037" />
      </Defs>
      <G stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <G>
            <G transform="translate(8.500000, 5.000000) rotate(-180.000000) translate(-8.500000, -5.000000) ">
